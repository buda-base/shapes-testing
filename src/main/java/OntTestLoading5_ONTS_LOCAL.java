...
public class OntTestLoading5_ONTS_LOCAL {

    public static Logger logger = LoggerFactory.getLogger(OntTestLoading5_ONTS_LOCAL.class);
    ...
    private static void initOdm() {
        ...
        writeTtl(odFm.getLocationMapper().toModel(), "LOCATOR_ONTS_LOCAL_05");
    }    
