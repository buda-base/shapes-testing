...
public class OntTestLoading5_ONTS_GH {

    public static Logger logger = LoggerFactory.getLogger(OntTestLoading5_ONTS_GH.class);

    
    private static final String OUT = "/Users/chris/BUDA/TEST_OUTPUT/";
    
    private static final String ONT_POLICY = "https://raw.githubusercontent.com/buda-base/owl-schema/master/ont-policy.rdf";
    ...
    private static void initOdm() {
        ...
        writeTtl(odFm.getLocationMapper().toModel(), "LOCATOR_ONTS_GH_05");
    }    
